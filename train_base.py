...
if __name__ == "__main__":
    ...
    # TODO
    # save_dir = 'logs/upper'
    # save_dir = 'logs/b15_n5'
    # save_dir = 'logs/b10_n10'
    save_dir = 'logs/b19_n1/base_1'
    # ------------------------------------------------------------------#
    ...
    # ----------------------------------------------------#
    # TODO
    train_annotation_path = './data_split/voc_base_classes_19_train.txt'
    val_annotation_path = './data_split/voc_base_classes_19_val.txt'
    # val_annotation_path = './data_split/voc_base_classes_10_val.txt'
    # train_annotation_path = './data_split/voc_base_classes_10_train.txt'
    # val_annotation_path = './data_split/voc_base_classes_15_val.txt'
    # train_annotation_path = './data_split/voc_base_classes_15_train.txt'
    # val_annotation_path = './data_split/2007_val.txt'
    # train_annotation_path = './data_split/2007_train.txt'
