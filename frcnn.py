...
from merge_weight import merge_cls_loc_weight
...
class FRCNN(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        # "model_path": './logs/b15_n5/best_epoch_weights.pth',
        # "model_path": './logs/b10_n10/best_epoch_weights.pth',
        "model_path": './logs/b19_n1/base/best_epoch_weights_2080ti.pth',
        # "model_path": './logs/b19_n1/incre_ewc_ft/best_epoch_weights.pth',
        # "model_path_old": './logs/b19_n1/base/best_epoch_weights.pth',
        # "model_path_incre": './logs/b19_n1/incre_ewc_ft/best_epoch_weights.pth',
    ...
    def generate(self):
        ...
        # merged_weight = merge_cls_loc_weight(self.model_path_old, self.model_path_incre)
        # self.net.load_state_dict(merged_weight)

        self.net = self.net.eval()
        print('{} model, anchors, and classes loaded.'.format(self.model_path))
        # print('{} model, anchors, and classes loaded.'.format('merged_weight'))
