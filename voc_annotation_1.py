...
# VOCdevkit_path = "E:\BaiduNetdiskDownload\VOC07+12+test"
...
if __name__ == "__main__":
    ...
    if annotation_mode == 0 or annotation_mode == 2:
        ...
        for year, image_set in VOCdevkit_sets:
            ...
            # zhq for incremental #TODO
            # list_file = open('%s_%s.txt' % ('./data_split/voc_base_classes_19', image_set), 'w', encoding='utf-8')
            list_file = open('%s_%s.txt' % ('./data_split/voc_incre_classes_1_nb', image_set), 'w', encoding='utf-8')
            # list_file = open('%s_%s.txt' % ('./data_split/voc_base_classes_10', image_set), 'w', encoding='utf-8')
            # list_file = open('%s_%s.txt' % ('./data_split/voc_base_classes_15', image_set), 'w', encoding='utf-8')
